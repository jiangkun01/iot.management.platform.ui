...
module.exports = {
  ...
  api: {
    ...
    deleteUser: '/api/core/user/delete',
    createUser: '/api/core/user/create',
    updateUser: '/api/core/user/update',
    deleteUserMu: '/api/core/user/deleteMu',
    validateByUserName: '/api/core/user/validateByUserName',
    roleList: '/api/core/role/list',
